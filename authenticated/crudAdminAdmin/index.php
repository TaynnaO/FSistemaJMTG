...
<html lang="pt-br">
  ...
  <meta charset="utf-8">
    ...
    <title>Administradores - Criar</title>
                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Lista de Administradores
                            <a href="usuario-create.php" class="btn btn-primary float-end">Adicionar administrador</a>
                        </h4>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    <?php
                                        ...
                                        echo '<h5>Nenhum administrador encontrado</h5>';
                                    }
                                ?>
                            </tbody>
                        </table>
